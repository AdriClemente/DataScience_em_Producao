...
### i.	Fillout NA
-	**i.	Competition Distance**: No site do Kagle [Rossmann's Store Sales Kaggle competition](https://www.kaggle.com/c/rossmann-store-sales/data) temos a seguinte definição para esta variável: distance in meter to the nearest competitor store.
