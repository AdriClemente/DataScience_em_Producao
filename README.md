...
- **Quarto gráfico - gráfico de resíduo, entre as valore preditos em relação ao erro**: Podemos observar ocorrem erros maiores quando o modelo faz predições entre R$6.000,00 e R$10.000,00.
